...
from . import agents, ik_abs_cobot_env_cfg, ik_rel_cobot_env_cfg, joint_pos_cobot_env_cfg
...
gym.register(
    id="Isaac-Lift-Cube-Cobot-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": joint_pos_cobot_env_cfg.CobotCubeLiftEnvCfg,
...
gym.register(
    id="Isaac-Lift-Cube-Cobot-IK-Rel-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
